        ...
        post(new Route("/play") {
            ...
            public Object handle(Request request, Response response) {
                ...
                String responseHtml = "<form method=\"post\" action=\"/play\" class=\"hidden\" id=\"game-form\">\n"
                        ...
                        + "</tr>\n"
                        + "<tr>\n"
                        + "<td class=\"tile"  + (!ticTacToeBoard[0][2].isEmpty() ? " checked" : "" ) + "\" id=\"x0y2\">"+ (ticTacToeBoard[0][1].isEmpty() ? " " : ticTacToeBoard[0][2]) + "</td>\n"
                        + "<td class=\"tile"  + (!ticTacToeBoard[1][2].isEmpty() ? " checked" : "" ) +  "\" id=\"x1y2\">"+ (ticTacToeBoard[1][1].isEmpty() ? " " : ticTacToeBoard[1][2]) + "</td>\n"
                        + "<td class=\"tile"  + (!ticTacToeBoard[2][2].isEmpty() ? " checked" : "" ) +  "\" id=\"x2y2\">"+ (ticTacToeBoard[2][1].isEmpty() ? " " : ticTacToeBoard[2][2]) + "</td>\n"
                        + "\n"
                        + "</tr>\n"
                        + "</table>\n"
                        + "</div>";
